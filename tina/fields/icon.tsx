...
export const IconPickerInput = ({ input }) => {
        ...
        {({ open }) => (
          <>
            <Popover.Button as={"span"}>
              <button
                className={`${InputIcon ? "h-11" : "h-10"} flex flex-row flex-wrap items-center justify-center px-4 my-4 shadow-sm rounded-full cursor-pointer border border-gray-200 focus:outline-none focus:shadow-outline focus:ring-blue-500 focus:border-blue-500 text-sm bg-white text-gray-700`}
              >
                {InputIcon && (
